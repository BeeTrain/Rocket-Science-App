...
import ru.chernakov.rocketscienceapp.extension.android.content.ContextKt;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private int mButtonSpacing = ContextKt.dip(getContext(), 0);
    private FloatingActionButton mMenuButton;
    private int mMaxButtonWidth;
    private int mLabelsMargin = ContextKt.dip(getContext(), 0);
    private int mLabelsVerticalOffset = ContextKt.dip(getContext(), 0);
    ...
    private int mLabelsPaddingTop = ContextKt.dip(getContext(), 4f);
    private int mLabelsPaddingRight = ContextKt.dip(getContext(), 8f);
    private int mLabelsPaddingBottom = ContextKt.dip(getContext(), 4f);
    private int mLabelsPaddingLeft = ContextKt.dip(getContext(), 8f);
    private ColorStateList mLabelsTextColor;
    private float mLabelsTextSize;
    private int mLabelsCornerRadius = ContextKt.dip(getContext(), 3f);
    ...
    private void createMenuButton() {
        ...
        if (mMenuShowShadow) {
            mMenuButton.mShadowRadius = ContextKt.dip(getContext(), mMenuShadowRadius);
            mMenuButton.mShadowXOffset = ContextKt.dip(getContext(), mMenuShadowXOffset);
            mMenuButton.mShadowYOffset = ContextKt.dip(getContext(), mMenuShadowYOffset);
        }
